...
var hamburgerShowBtn = document.querySelector('.hamburger');
var hamburgerHideBtn = document.querySelector('.hamburger-close');
var hamburgerMenu = document.querySelector('.hamburger-block');

var showMenu = function showMenu() {
  hamburgerMenu.classList.remove('hidden');
  hamburgerShowBtn.removeEventListener('click', showMenu);
  hamburgerHideBtn.addEventListener('click', hideMenu);
};

var hideMenu = function hideMenu() {
  hamburgerMenu.classList.add('hidden');
  hamburgerShowBtn.addEventListener('click', showMenu);
  hamburgerHideBtn.removeEventListener('click', hideMenu);
};
...
/* harmony import */ var _hamburger_menu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./hamburger-menu.js */ "./src/js/hamburger-menu.js");
/* harmony import */ var _hamburger_menu_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_hamburger_menu_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _scrollbar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scrollbar */ "./src/js/scrollbar.js");
/* harmony import */ var _scrollbar__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_scrollbar__WEBPACK_IMPORTED_MODULE_3__);
...
var countSlider = document.querySelector('.scrollbar__count-last');
var previewSliderPerView = window.innerWidth < 976 ? 1 : 3;
countSlider.textContent = "".concat(document.querySelectorAll('.preview-slider__container > .swiper-wrapper > .swiper-slide').length);
var previewInititalSlide = 1;
var previewSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.preview-slider__container', {
  // Optional parameters
  direction: 'horizontal',
  slidesPerView: previewSliderPerView,
  initialSlide: previewInititalSlide,
  loop: true,
  // Navigation arrows
  navigation: {
...
if (window.innerWidth > 796) {
  var photographySlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.photography-slider-container.photography__slider-pc', {
    // Optional parameters
    direction: 'vertical',
    slidesPerView: 1,
    loop: true,
    ...
    // Navigation arrows
    navigation: {
      nextEl: '.photography-slider-button-next',
      prevEl: '.photography-slider-button-prev'
    },
    centeredSlides: true
  });
}

var photographySliderMobilePerView = window.innerWidth < 610 ? 1 : 2.1;

if (window.innerWidth < 796) {
  var _photographySlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.photography-slider-container.photography__slider-mobile', {
    // Optional parameters
    direction: 'horizontal',
    slidesPerView: photographySliderMobilePerView,
    loop: true,
    // Navigation arrows
    navigation: {
      nextEl: '.photography-slider-button-next',
...
var scrollBar = document.querySelector('.preview-slider__container > .swiper-scrollbar');
var scrollBarDrag = scrollBar.querySelector('.swiper-scrollbar-drag');
var scrollBarWidth = scrollBar.offsetWidth;
var lengthSlider = document.querySelectorAll('.preview-slider > .swiper-container > .swiper-wrapper > .swiper-slide').length - document.querySelectorAll('.preview-slider > .swiper-container > .swiper-wrapper > .swiper-slide-duplicate').length;
var nextBtn = document.querySelector('.preview-slider-button-next');
var prevBtn = document.querySelector('.preview-slider-button-prev');
var step = Math.floor(scrollBarWidth / lengthSlider);
var current = previewInititalSlide * step;
scrollBarDrag.style.transform = "translate(".concat(current, "px)");
var finalPosition = scrollBarWidth - scrollBarDrag.offsetWidth;
nextBtn.addEventListener('click', function () {
  if (current === finalPosition) {
    scrollBarDrag.style.transform = "translate(".concat(0, ")");
    current = 0;
    return;
  }

  scrollBarDrag.style.transform = "translate(".concat(current + 19, "px)");
  current += step;
});
prevBtn.addEventListener('click', function () {
  if (current === 0) {
    scrollBarDrag.style.transform = "translate(".concat(finalPosition, "px)");
